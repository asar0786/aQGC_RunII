           ...
           const TString OutPutRootFileName = "ch1_splitted_TF1_WV")
{
    ...
    TFile *outFile1 = new TFile("ch1_splitted_TF1_hft1.root","RECREATE");
    TFile *outFile2 = new TFile("ch1_splitted_TF1_hft0.root","RECREATE");
    TFile *outFile3 = new TFile("ch1_splitted_TF1_hft2.root","RECREATE");
    TFile *outFile4 = new TFile("ch1_splitted_TF1_hft5.root","RECREATE");
    TFile *outFile5 = new TFile("ch1_splitted_TF1_hft7.root","RECREATE");
    TFile *outFile6 = new TFile("ch1_splitted_TF1_hft6.root","RECREATE");
    TFile *outFile7 = new TFile("ch1_splitted_TF1_hfm6.root","RECREATE");
    TFile *outFile8 = new TFile("ch1_splitted_TF1_hfm7.root","RECREATE");
    TFile *outFile9 = new TFile("ch1_splitted_TF1_hfm4.root","RECREATE");
    TFile *outFile10 = new TFile("ch1_splitted_TF1_hfm5.root","RECREATE");
    TFile *outFile11 = new TFile("ch1_splitted_TF1_hfm2.root","RECREATE");
    TFile *outFile12 = new TFile("ch1_splitted_TF1_hfm3.root","RECREATE");
    TFile *outFile13 = new TFile("ch1_splitted_TF1_hfm0.root","RECREATE");
    TFile *outFile14 = new TFile("ch1_splitted_TF1_hfm1.root","RECREATE");
    TFile *outFile15 = new TFile("ch1_splitted_TF1_hfs0.root","RECREATE");
    TFile *outFile16 = new TFile("ch1_splitted_TF1_hfs1.root","RECREATE");
    TFile *outFile17 = new TFile("ch1_splitted_TF1_hft8.root","RECREATE");
    TFile *outFile18 = new TFile("ch1_splitted_TF1_hft9.root","RECREATE");
...
//        TH1D  *hfs0  = new TH1D(hist_name, hist_name, sizeof(fs0)/sizeof(fs0[0])-1 ,fs0[0]-0.5, fs0[sizeof(fs0)/sizeof(fs0[0])-1]-0.5 );
        ...
        TH1D  *hfm2  = new TH1D(hist_name, hist_name, sizeof(fm2)/sizeof(fm2[0])-1 ,fm2[0], fm2[sizeof(fm2)/sizeof(fm2[0])-1] );
        TH1D  *hfm3  = new TH1D(hist_name, hist_name, sizeof(fm3)/sizeof(fm3[0])-1 ,fm3[0], fm3[sizeof(fm3)/sizeof(fm3[0])-1] );
        TH1D  *hfm4  = new TH1D(hist_name, hist_name, sizeof(fm4)/sizeof(fm4[0])-1 ,fm4[0], fm4[sizeof(fm4)/sizeof(fm4[0])-1] );
        TH1D  *hfm5  = new TH1D(hist_name, hist_name, sizeof(fm5)/sizeof(fm5[0])-1 ,fm5[0], fm5[sizeof(fm5)/sizeof(fm5[0])-1] );
        ...
        TH1D  *hft5  = new TH1D(hist_name, hist_name, sizeof(ft5)/sizeof(ft5[0])-1 ,ft5[0], ft5[sizeof(ft5)/sizeof(ft5[0])-1] );
        TH1D  *hft6  = new TH1D(hist_name, hist_name, sizeof(ft6)/sizeof(ft6[0])-1 ,ft6[0], ft6[sizeof(ft6)/sizeof(ft6[0])-1] );
        TH1D  *hft7  = new TH1D(hist_name, hist_name, sizeof(ft7)/sizeof(ft7[0])-1 ,ft7[0], ft7[sizeof(ft7)/sizeof(ft7[0])-1] );
        TH1D  *hft8  = new TH1D(hist_name, hist_name, sizeof(ft8)/sizeof(ft8[0])-1 ,ft8[0], ft8[sizeof(ft8)/sizeof(ft8[0])-1] );
        TH1D  *hft9  = new TH1D(hist_name, hist_name, sizeof(ft9)/sizeof(ft9[0])-1 ,ft9[0], ft9[sizeof(ft9)/sizeof(ft9[0])-1] );
...
//		cout<<"size of ft1: "<<temp_size<<endl;
...
//                if (DEBUG) std::cout << "ft1: " <<j<<", aQGC content: "<< histo_aqgc[j]->GetBinContent(i) << " EWK content: " << hists[1]->GetBinContent(i) << " err: " << err << " hfs0 bin content: " << hfs0->GetBinContent(j-0+1) <<" w: "<<w<<" Bin info in hfs0: "<<temp_size/2 + 1 + temp_numbers[j-0]<< std::endl;
            ...
            {
        int temp_size = sizeof(ft0)/sizeof(ft0[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                //if (DEBUG) std::cout << "ft0 \t " <<j<<" :"<< histo_aqgc[j]->GetBinContent(i) << " " << hists[1]->GetBinContent(i) << " " << histo_aqgc[j]->GetBinError(i) << " " <<  hists[1]->GetBinError(i) << " " << err << "\t" << hft0->GetBinContent(j-35+1) << std::endl;
                ...
                hft0->SetBinContent(temp_size/2 + 1 + temp_numbers[j-35],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hft0->SetBinError(temp_size/2 + 1 + temp_numbers[j-35],err);
            }
            else if(j>=70 && j<105)
            {
        int temp_size = sizeof(ft2)/sizeof(ft2[0]);

                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j-0]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hft2->SetBinContent(temp_size/2 + 1 + temp_numbers[j-70],histo_aqgc[j-0]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hft2->SetBinError(temp_size/2 + 1 + temp_numbers[j-70],err);
         //       if (DEBUG) std::cout << "ft2 \t " <<j<<" :"<< histo_aqgc[j]->GetBinContent(i) << " " << hists[1]->GetBinContent(i) << " " << histo_aqgc[j]->GetBinError(i) << " " <<  hists[1]->GetBinError(i) << " " << err << "\t" << hft2->GetBinContent(j-70+1) << std::endl;
                //hft2->SetBinContent(j+1-604,histo_aqgc[j-0]->GetBinContent(i)/hists[1]->GetBinContent(i));
            }
            else if(j>=105 && j<144) 
            {
        int temp_size = sizeof(ft5)/sizeof(ft5[0]);
                ...
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hft5->SetBinContent(temp_size/2 + 1 + temp_numbers[j-105],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hft5->SetBinError(temp_size/2 + 1 + temp_numbers[j-105],err);
            }
            else if(j>=144 && j<195) 
            {
        int temp_size = sizeof(ft7)/sizeof(ft7[0]);
                double w = histo_aqgc[j-0]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j-0]->GetBinError(i)/histo_aqgc[j-0]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hft7->SetBinContent(temp_size/2 + 1 + temp_numbers[j-144],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hft7->SetBinError(temp_size/2 + 1 + temp_numbers[j-144],err);
            }
            else if(j>=195 && j<238) 
            {
        int temp_size = sizeof(ft6)/sizeof(ft6[0]);
                double w = histo_aqgc[j-0]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j-0]->GetBinError(i)/histo_aqgc[j-0]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hft6->SetBinContent(temp_size/2 + 1 + temp_numbers[j-195],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hft6->SetBinError(temp_size/2 + 1 + temp_numbers[j-195],err);
            }
            else if(j>=238 && j<273) 
            {
        int temp_size = sizeof(fm6)/sizeof(fm6[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm6->SetBinContent(temp_size/2 + 1 + temp_numbers[j-238],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm6->SetBinError(temp_size/2 + 1 + temp_numbers[j-238],err);
            }
            else if(j>=273 && j<304) 
            {
        int temp_size = sizeof(fm7)/sizeof(fm7[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm7->SetBinContent(temp_size/2 + 1 + temp_numbers[j-273],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm7->SetBinError(temp_size/2 + 1 + temp_numbers[j-273],err);
            }
            else if(j>=304 && j<341) 
            {
        int temp_size = sizeof(fm4)/sizeof(fm4[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm4->SetBinContent(temp_size/2 + 1 + temp_numbers[j-304],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm4->SetBinError(temp_size/2 + 1 + temp_numbers[j-304],err);
            }
            else if(j>=341 && j<386) 
            {
        int temp_size = sizeof(fm5)/sizeof(fm5[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm5->SetBinContent(temp_size/2 + 1 + temp_numbers[j-341],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm5->SetBinError(temp_size/2 + 1 + temp_numbers[j-341],err);
            }
            else if(j>=386 && j<417) 
            {
        int temp_size = sizeof(fm2)/sizeof(fm2[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm2->SetBinContent(temp_size/2 + 1 + temp_numbers[j-386],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm2->SetBinError(temp_size/2 + 1 + temp_numbers[j-386],err);
            }
            else if(j>=417 && j<448) 
            {
        int temp_size = sizeof(fm3)/sizeof(fm3[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm3->SetBinContent(temp_size/2 + 1 + temp_numbers[j-417],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm3->SetBinError(temp_size/2 + 1 + temp_numbers[j-417],err);
            }
            else if(j>=448 && j<489) 
            {
        int temp_size = sizeof(fm0)/sizeof(fm0[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm0->SetBinContent(temp_size/2 + 1 + temp_numbers[j-448],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm0->SetBinError(temp_size/2 + 1 + temp_numbers[j-448],err);
            }
            else if(j>=489 && j<526) 
            {
        int temp_size = sizeof(fm1)/sizeof(fm1[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfm1->SetBinContent(temp_size/2 + 1 + temp_numbers[j-489],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfm1->SetBinError(temp_size/2 + 1 + temp_numbers[j-489],err);
            }
            else if(j>=526 && j<569) 
            {
        int temp_size = sizeof(fs0)/sizeof(fs0[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
            ...
            {
        int temp_size = sizeof(fs1)/sizeof(fs1[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hfs1->SetBinContent(temp_size/2 + 1 + temp_numbers[j-569],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hfs1->SetBinError(temp_size/2 + 1 + temp_numbers[j-569],err);
            }
            else if(j>=602 && j<637) 
            {
        int temp_size = sizeof(ft8)/sizeof(ft8[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hft8->SetBinContent(temp_size/2 + 1 + temp_numbers[j-602],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hft8->SetBinError(temp_size/2 + 1 + temp_numbers[j-602],err);
            }
            else if(j>=637 && j<678) 
            {
        int temp_size = sizeof(ft9)/sizeof(ft9[0]);
                double w = histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i);
                double e1 = histo_aqgc[j]->GetBinError(i)/histo_aqgc[j]->GetBinContent(i);
                double e2 = hists[1]->GetBinError(i)/hists[1]->GetBinContent(i);
                double err = sqrt(e1*e1+e2*e2)*w;//TMath::Abs(((1-2*w)*e1*e1 + w*w*e2*e2 )/(hists[1]->GetBinContent(i)*hists[1]->GetBinContent(i)));
                hft9->SetBinContent(temp_size/2 + 1 + temp_numbers[j-637],histo_aqgc[j]->GetBinContent(i)/hists[1]->GetBinContent(i));
                hft9->SetBinError(temp_size/2 + 1 + temp_numbers[j-637],err);
            }
        }
        outFile1->cd();
        TF1 *fit_1 = new TF1(hist_name,"pol2",ft1[0]-0.25,ft1[sizeof(ft1)/sizeof(ft1[0])-1]-0.25);
        //hft1->Fit(hist_name,"R");
        //fit_1->Write();
        hft1->Write();
        
	outFile2->cd();
        TF1 *fit_2 = new TF1(hist_name,"pol4",ft0[0]-0.1,ft0[sizeof(ft0)/sizeof(ft0[0])-1]-0.1);
        hft0->Fit(hist_name,"R");
        //fit_2->Write();
        hft0->Write();

        outFile3->cd();
        TF1 *fit_3 = new TF1(hist_name,"pol2",ft2[0]-0.25,ft2[sizeof(ft2)/sizeof(ft2[0])-1]-0.25);
        //hft2->Fit(hist_name,"R");
        //fit_3->Write();
        hft2->Write();

	outFile4->cd();
        TF1 *fit_4 = new TF1(hist_name,"pol2",ft5[0]-0.1,ft5[sizeof(ft5)/sizeof(ft5[0])-1]-0.1);
        hft5->Fit(hist_name,"R");
        //fit_4->Write();
        hft5->Write();

	outFile5->cd();
        TF1 *fit_5 = new TF1(hist_name,"pol2",ft7[0]-0.1,ft7[sizeof(ft7)/sizeof(ft7[0])-1]-0.1);
        hft7->Fit(hist_name,"R");
        //fit_5->Write();
        hft7->Write();

	outFile6->cd();
        TF1 *fit_6 = new TF1(hist_name,"pol2",ft6[0]-0.1,ft6[sizeof(ft6)/sizeof(ft6[0])-1]-0.1);
        hft6->Fit(hist_name,"R");
        //fit_6->Write();
        hft6->Write();

	outFile7->cd();
        TF1 *fit_7 = new TF1(hist_name,"pol2",fm6[0]-0.1,fm6[sizeof(fm6)/sizeof(fm6[0])-1]-0.1);
        hfm6->Fit(hist_name,"R");
        //fit_7->Write();
        hfm6->Write();

	outFile8->cd();
        TF1 *fit_8 = new TF1(hist_name,"pol2",fm7[0]-0.1,fm7[sizeof(fm7)/sizeof(fm7[0])-1]-0.1);
        hfm7->Fit(hist_name,"R");
        //fit_8->Write();
        hfm7->Write();

	outFile9->cd();
        TF1 *fit_9 = new TF1(hist_name,"pol2",fm4[0]-0.1,fm4[sizeof(fm4)/sizeof(fm4[0])-1]-0.1);
        hfm4->Fit(hist_name,"R");
        //fit_9->Write();
        hfm4->Write();

	outFile10->cd();
        TF1 *fit_10 = new TF1(hist_name,"pol2",fm5[0]-0.1,fm5[sizeof(fm5)/sizeof(fm5[0])-1]-0.1);
        hfm5->Fit(hist_name,"R");
        //fit_10->Write();
        hfm5->Write();

	outFile11->cd();
        TF1 *fit_11 = new TF1(hist_name,"pol2",fm2[0]-0.1,fm2[sizeof(fm2)/sizeof(fm2[0])-1]-0.1);
        hfm2->Fit(hist_name,"R");
        //fit_11->Write();
        hfm2->Write();

	outFile12->cd();
        TF1 *fit_12 = new TF1(hist_name,"pol2",fm3[0]-0.1,fm3[sizeof(fm3)/sizeof(fm3[0])-1]-0.1);
        hfm3->Fit(hist_name,"R");
        //fit_12->Write();
        hfm3->Write();

	outFile13->cd();
        TF1 *fit_13 = new TF1(hist_name,"pol2",fm0[0]-0.1,fm0[sizeof(fm0)/sizeof(fm0[0])-1]-0.1);
        hfm0->Fit(hist_name,"R");
        //fit_13->Write();
        hfm0->Write();

	outFile14->cd();
        TF1 *fit_14 = new TF1(hist_name,"pol2",fm1[0]-0.1,fm1[sizeof(fm1)/sizeof(fm1[0])-1]-0.1);
        hfm1->Fit(hist_name,"R");
        //fit_14->Write();
        hfm1->Write();

        outFile15->cd();
        TF1 *fit_15 = new TF1(hist_name,"pol2",fs0[0]-10,fs0[sizeof(fs0)/sizeof(fs0[0])-1]-10);
        //hfs0->Fit(hist_name,"R");
        //fit_15->Write();
        hfs0->Write();

        outFile16->cd();
        TF1 *fit_16 = new TF1(hist_name,"pol2",fs1[0]-5,fs1[sizeof(fs1)/sizeof(fs1[0])-1]-5);
        //hfs1->Fit(hist_name,"R");
        //fit_16->Write();
        hfs1->Write();

        outFile17->cd();
        TF1 *fit_17 = new TF1(hist_name,"pol2",ft8[0]-0.5,ft8[sizeof(ft8)/sizeof(ft8[0])-1]-0.5);
        //hft8->Fit(hist_name,"R");
        //fit_17->Write();
        hft8->Write();

        outFile18->cd();
        TF1 *fit_18 = new TF1(hist_name,"pol2",ft9[0]-2.5,ft9[sizeof(ft9)/sizeof(ft9[0])-1]-2.5);
        //hft9->Fit(hist_name,"R");
        //fit_18->Write();
        hft9->Write();
        //f.Write();
    ...
    //outFile->Write();
    outFile1->Close();outFile2->Close();outFile3->Close();outFile4->Close();outFile5->Close();outFile6->Close();outFile7->Close();outFile8->Close(); outFile9->Close();outFile10->Close();outFile11->Close();outFile12->Close();outFile13->Close();outFile14->Close();outFile15->Close();outFile16->Close();
